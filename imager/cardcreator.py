...
# from imager.helpertools import change_colors
...
font_bold = "fonts/AnonymousPro/AnonymousPro-Bold.ttf"
font_italic = "fonts/AnonymousPro/AnonymousPro-Italic.ttf"
font_regular = "fonts/AnonymousPro/AnonymousPro-Regular.ttf"
font_ExtraCondensedExtraBold = 'fonts/NotoSans/NotoSans-ExtraCondensedExtraBold.ttf'
font_ExtraCondensed = 'fonts/NotoSans/NotoSans-ExtraCondensed.ttf'

record_watermark = "resources/record.png"
...
def _print_album_and_artist(im, album, artist, font, font_size, offset):
    ...
    # draw.line((offset, width - offset/2 + album_font.getsize_multiline(multiline_album)[1] + offset/4,
    #           width - offset, width - offset/2 + album_font.getsize_multiline(multiline_album)[1] + offset/4),
...
#album_details = search_songlink_album(album_id)

#front = generate_card_front(album_details, int(277 / 4 * 0.0393700787 * 300), int(203 / 2 * 0.0393700787 * 300))
#front.save("C:/Users/mayan/Workspace/music-cards/outputs/%s_front.jpg" % album_id)
#front.show()

#back = generate_card_back(album_details, int(277 / 4 * 0.0393700787 * 300), int(203 / 2 * 0.0393700787 * 300))
#back.save("C:/Users/mayan/Workspace/music-cards/outputs/%s_back.jpg" % album_id)
#back.show()

# long album 1121282822
# medium long album 3966930
# Redhot 947680622
# Red : 1440935340
